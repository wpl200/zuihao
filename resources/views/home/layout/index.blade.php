        ...
        <div class="container">
            ...
            @if(!empty(session('log'))) 
                <div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                    ...
                    <ul>
                        <li><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i><a href="{{ url('/home/login/outlog') }}">登陆</a></li>
                        <li><i class="glyphicon glyphicon-book" aria-hidden="true"></i><a href="{{ url('/home/reg') }}">注册</a></li>
                    </ul>
                </div>
                <div class="header-grid-right an    imated wow slideInRight" data-wow-delay=".5s">
                    <ul class="social-icons">
                   
                        <li>欢迎您，　<a href="/home/person/{{ session('log')->uid }}">{{ session('log')->uname }}</a></li>
                        <li>&nbsp;</li>
                        <li><a href="{{ url('/home/login/outlog') }}">［退出］</a></li>
                    </ul>
                </div>
                @else
                <div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                    <ul>
                         <li><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i><a href="{{ url('/home/login/outlog') }}">登陆</a></li> 或
                        <li><i class="glyphicon glyphicon-book" aria-hidden="true"></i><a href="{{ url('/home/reg') }}">注册</a></li>
                    </ul>
                </div>
                @endif
